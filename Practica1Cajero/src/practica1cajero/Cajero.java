...
public class Cajero {
    ...
    public Cajero() {
        ...
        usuarios = new Cliente[2];
        usuarios[0] = new Cliente("1234", "Juan", 1000.0);
        usuarios[1] = new Cliente("5678", "Maria", 2500.0);
        usuarioActual = -1;
    }
...
"                                                                     |__/                ");
        ...
        while (intentos < 3 && usuarioActual == -1) {
            ...
            for (int i = 0; i < usuarios.length; i++) {
                if (usuarios[i].getPin().equals(pinIngresado)) {
                    usuarioActual = i;
                    break;
                }
            }
        ...
        System.out.println("Bienvenido, " + usuarios[usuarioActual].getNombre());
        ...
        while (!salir) {
            ...
            if (opcion == 1) {
                System.out.println("Su saldo es: $" + usuarios[usuarioActual].getSaldo());
            } else if (opcion == 2) {
                System.out.print("Ingrese cantidad a retirar: ");
                double retiro = scanner.nextDouble();
                if (usuarios[usuarioActual].retirar(retiro)) {
                    System.out.println("Retiro exitoso. Nuevo saldo: $" + usuarios[usuarioActual].getSaldo());
                } else {
                ...
                usuarios[usuarioActual].depositar(deposito);
                System.out.println("Depósito exitoso. Nuevo saldo: $" + usuarios[usuarioActual].getSaldo());
            } else if (opcion == 4) {
                salir = true;
